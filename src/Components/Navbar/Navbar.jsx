      ...
      >
        <div className="w-full py-[1rem] flex items-center max-h-[60px] !justify-between gap-[1rem]  ">
          <div className="flex flex-row  !gap-[48px] justify-between items-center">
            ...
            <div>
              <div className=" pr-[8px] min-h-[40px] min-w-[400px] flex items-center w-full !bg-[#F3F3F4] rounded-full">
                <input
                  type="text"
                  placeholder="What are you looking for?"
                  className="w-full h-full border-none !bg-[#F3F3F4] rounded-full outline-none text-[16px] pl-[24px] placeholder:text-[16px]"
                />
                <button className="min-w-[30px] min-h-[30px]  rounded-full bg-[#6B8E23] border-[1px] !border-[#6B8E23] text-white flex items-center justify-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
