    ...
    <div className="flex  items-center justify-center overflow-hidden w-full">
      ...
      >
        <div className="flex items-center justify-center gap-[1rem]">
          ...
          {/* Right side */}
          <div className="right-section  p-[2rem]  flex-[.75] flex flex-col items-start gap-[2rem] rounded-[1rem] text-white backdrop-sepia-0 bg-white/30">
            ...
            <form className="form">
              <div className="input-group">
                ...
                <div className="input-wrapper">
                  <input
                    type="text"
                    placeholder="Tell You mates Where you are going"
                  />
                </div>
              </div>
